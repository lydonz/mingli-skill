    ...
    return {
        ...
        **preference,
        "legacy_preference": {
            **legacy_preference,
            "deprecated": True,
            "note": "仅为迁移观察保留；新解释和流年规则不读取，也不参与冲突判定。",
        },
        "evidence": {
        ...
        # The deprecated fields are generated by the historical calculator and
        # are expected to differ from the v2 ruleset.  They must not degrade
        # every ordinary chart; real calculation conflicts should be added by
        # the caller when a canonical input or backend actually disagrees.
        "conflicts": [],
    }
