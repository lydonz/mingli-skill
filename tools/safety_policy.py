...
_CATEGORY_SUPPRESSIONS = {
    ...
    "医疗": (
        "医疗问题不生成规则选项预测；请以合格医疗专业人员的评估为准。"
    ),
    "子女": (
        "怀孕、生育和子女结果不生成规则选项预测。"
    ),
    "外貌": (
        "不根据外貌推断健康、智力、财富、品行、婚姻或命运。"
    ),
}
_HIGH_RISK_TERMS = re.compile(
    r"死亡|去世|早亡|自杀|自伤|自残|抑郁|癌|肿瘤|绝症|诊断|手术|开刀|用药|住院|"
    r"投资|股票|基金|期货|借贷|贷款|保险|赌博|破产|负债|融资|"
    r"离婚|怀孕|流产|不孕|生育|分娩|家暴|殴打|虐待|入狱|坐牢|"
    r"雇佣|录取|解雇|信贷|学历|博士|硕士|本科|贫困|赤贫|大富"
)
